...
%% 4+5) PG-Agent (klassischer Policy-Gradient)
...
agent.AgentOptions.EntropyLossWeight = 1e-3;   % Exploration
agent.AgentOptions.UseBaseline       = true;   % Critic als Baseline
...
save('SpaceRobot_PG_agent.mat','agent');
